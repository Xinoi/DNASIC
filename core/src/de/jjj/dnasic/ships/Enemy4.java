...
public class Enemy4 extends EnemyShip {
    ...
    public Enemy4(float x, float y) {
        super(new TextureAtlas(Gdx.files.internal("TextureAtlas/packed/NPC_Ship/NPC_Ship.atlas")).findRegion("Ship_4"), x, y, 1, 1, 50, new Weapon[3]);
