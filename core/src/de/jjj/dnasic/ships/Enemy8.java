...
public class Enemy8 extends EnemyShip {
    ...
    public Enemy8(float x, float y, SpriteBatch batch) {
        super(new TextureAtlas(Gdx.files.internal("TextureAtlas/packed/NPC_Ship/NPC_Ship.atlas")).findRegion("Ship_8"), x, y, 1, 1, 100, new Weapon[1], batch);
