...
public class Enemy1 extends EnemyShip {
    ...
    public Enemy1(SpawnPoint p, SpriteBatch batch) {
        super(new TextureAtlas(Gdx.files.internal("TextureAtlas/packed/NPC_Ship/NPC_Ship.atlas")).findRegion("Ship_1"), p.getX(), p.getY(), 2, 1, 50, new Weapon[1], batch);

        this.setWeapon(0, new Weapon(10, 700));
    }
}
